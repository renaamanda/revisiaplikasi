...
function tgl_indo($tanggal)
{
    ...
    <h3 align="center" style="font-size: 16px;"><u>LAPORAN PENGIRIMAN <?php if($nama_wilayah!="SEMUA"):?><?php echo strtoupper($nama_wilayah);?><?php endif;?> <br> BULAN <?php echo strtoupper($bulan);?> TAHUN <?php echo strtoupper($tahun);?> </u> <br> </h3>
    <br>
